...
\begin{figure}[!ht]
  ...
  \caption[Predictive melody features, Abdullah Ibrahim.]{Predictive melody features, Abdullah Ibrahim. This figure (and those following) shows standardised odds ratios obtained for every performer, following Figure~\ref{fig:rsi_predictive_melody_features}\deleted[id=HC]{ in the full paper}.}
