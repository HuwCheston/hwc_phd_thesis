...
The following tables contain the free text responses given by participants in the online surveys completed following each condition in the experiment, as described in Section~\ref{sec:mp_experimental_procedure}. Not all participants chose to provide free text responses, and some only commented on a minority of conditions.

Responses have been edited to ensure the anonymity of participants, such that direct references to participant’s names have been replaced by generic statements corresponding to their instrument, instead (e.g., ``the drummer'', ``the pianist''). No other editorial changes have been made and the spelling and grammar of the original responses (which were entered by participants on mobile phones, tablets, and laptops) has been maintained. 
...
\begin{sidewaystable}[]
\centering
\caption[Musician self-reports: latency: 0 ms, jitter: 0.0x]{Latency: 0 ms, Jitter: 0.0x}
...
\begin{sidewaystable}[]
\centering
\caption[Musician self-reports: latency: 23 ms, jitter: 0.0x]{Latency: 23 ms, Jitter: 0.0x}
\begin{tabular}{l c c p{15cm}}
\toprule
\textbf{Instrument} & \textbf{Duo} & \textbf{Session} & \textbf{Comment} \\ \midrule
...
\begin{sidewaystable}[]
\centering
\caption[Musician self-reports: latency: 23 ms, jitter: 0.5x]{Latency: 23 ms, Jitter: 0.5x}
\begin{tabular}{l c c p{15cm}}
\toprule
\textbf{Instrument} & \textbf{Duo} & \textbf{Session} & \textbf{Comment} \\ \midrule
...
\begin{sidewaystable}[]
\centering
\caption[Musician self-reports: latency: 23 ms, jitter: 1.0x]{Latency: 23 ms, Jitter: 1.0x}
\begin{tabular}{l c c p{15cm}}
\toprule
\textbf{Instrument} & \textbf{Duo} & \textbf{Session} & \textbf{Comment} \\ \midrule
...
\begin{sidewaystable}[]
\centering
\caption[Musician self-reports: latency: 45 ms, jitter: 0.0x]{Latency: 45 ms, Jitter: 0.0x}
\begin{tabular}{l c c p{15cm}}
\toprule
\textbf{Instrument} & \textbf{Duo} & \textbf{Session} & \textbf{Comment} \\ \midrule
...
\begin{sidewaystable}[]
\centering
\caption[Musician self-reports: latency: 45 ms, jitter: 0.5x]{Latency: 45 ms, Jitter: 0.5x}
\begin{tabular}{l c c p{15cm}}
\toprule
\textbf{Instrument} & \textbf{Duo} & \textbf{Session} & \textbf{Comment} \\ \midrule
...
\begin{sidewaystable}[]
\centering
\caption[Musician self-reports: latency: 45 ms, jitter: 1.0x]{Latency: 45 ms, Jitter: 1.0x}
\begin{tabular}{l c c p{15cm}}
\toprule
\textbf{Instrument} & \textbf{Duo} & \textbf{Session} & \textbf{Comment} \\ \midrule
...
\begin{sidewaystable}[]
\centering
\caption[Musician self-reports: latency: 90 ms, jitter: 0.0x]{Latency: 90ms, Jitter: 0.0x}
\begin{tabular}{l c c p{15cm}}
\toprule
\textbf{Instrument} & \textbf{Duo} & \textbf{Session} & \textbf{Comment} \\ \midrule
...
\begin{sidewaystable}[]
\centering
\caption[Musician self-reports: latency: 90 ms, jitter: 0.5x]{Latency: 90ms, Jitter: 0.5x}
\begin{tabular}{l c c p{15cm}}
\toprule
\textbf{Instrument} & \textbf{Duo} & \textbf{Session} & \textbf{Comment} \\ \midrule
...
\begin{sidewaystable}[]
\centering
\caption[Musician self-reports: latency: 90 ms, jitter: 1.0x]{Latency: 90ms, Jitter: 1.0x}
\begin{tabular}{l c c p{15cm}}
\toprule
\textbf{Instrument} & \textbf{Duo} & \textbf{Session} & \textbf{Comment} \\ \midrule
...
\begin{sidewaystable}[]
\centering
\caption[Musician self-reports: latency: 180 ms, jitter: 0.0x]{Latency: 180ms, Jitter: 0.0x}
\begin{tabular}{l c c p{15cm}}
\toprule
\textbf{Instrument} & \textbf{Duo} & \textbf{Session} & \textbf{Comment} \\ \midrule
...
\begin{sidewaystable}[]
\centering
\caption[Musician self-reports: latency: 180 ms, jitter: 0.5x]{Latency: 180ms, Jitter: 0.5x}
\begin{tabular}{l c c p{15cm}}
\toprule
\textbf{Instrument} & \textbf{Duo} & \textbf{Session} & \textbf{Comment} \\ \midrule
...
\begin{sidewaystable}[]
\centering
\caption[Musician self-reports: latency: 180 ms, jitter: 1.0x]{Latency: 180ms, Jitter: 1.0x}
\begin{tabular}{l c c p{15cm}}
\toprule
\textbf{Instrument} & \textbf{Duo} & \textbf{Session} & \textbf{Comment} \\ \midrule
