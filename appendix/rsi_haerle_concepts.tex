...
\begin{sidewaystable}[ht]
    \centering
    \caption{Concept dataset. A description of the twenty chapters in \citet{Haerle1994} that make up the concept dataset. The text is adapted and summarised from the didactic descriptions given by Haerle that precede each chapter.}
