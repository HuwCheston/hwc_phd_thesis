...
% Adding packages
\usepackage{graphicx, booktabs, rotating, svg, subfig, amsmath, placeins, url, minted, amsfonts, float, tabularx, multirow}
...
\newglossaryentry{ATEPP}{
    name=ATEPP,
    description={Automatically Transcribed Expressive Piano Performances dataset \citep{Zhang2022-atepp}}
}
\newglossaryentry{AIC}{
    name=AIC,
