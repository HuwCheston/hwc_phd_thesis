...
\item[--]{The instrument labels and audio files in \GLS{JTD} were included as part of the dataset used to train Aria-CL, a solo piano classifier.\footnote{\url{https://github.com/loubbrad/aria-cl}} This model, in turn, has been employed to create a new dataset of automatically transcribed solo piano recordings in MIDI format, spanning many different musical genres \citep{Bradshaw2025}.}
