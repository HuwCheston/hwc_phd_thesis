...
\begin{figure}[]
  ...
  \caption{Corpus construction. Each horizontal bar shows the duration of the recording career for each of the ten pianists included in JTD-300; markers indicate the date of recordings that appear in JTD-300, randomly jittered horizontally and vertically for visual clarity.}
...
\begin{figure}[]
  ...
  \caption{Recording durations. Each column shows the total duration of the recordings by each bandleader in JTD-300, with the green proportion corresponding with those tracks that are included within each subset (shown also as a percentage along the columns).}
