...
\begin{enumerate}
    \item{A high-resolution automatic piano transcription model \citep{Kong2021}, which generates MIDI (incorporating pitch, note and pedal onset and offset times, and velocity) from piano audio using a convolutional recurrent neural network (\GLS{CRNN}),}
