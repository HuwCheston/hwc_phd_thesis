...
These requirements are set to (1) ensure that all notes have clear onset times, and (2) maximise the acoustic similarity between the recordings in the dataset and the distribution of (mostly pop \& rock) material typically used to train audio source separation models. 
