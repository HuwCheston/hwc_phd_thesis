...
\begin{figure}[]
  ...
  \caption{Recording durations in JTD-300. Each column shows the total duration of the recordings by every bandleader with recordings in JTD-300, with the green proportion corresponding with those tracks that are included within each subset (shown also as a percentage along the columns).}
