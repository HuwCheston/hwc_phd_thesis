...
Finally, we note that the lower-dimensional space obtained through \GLS{PCA} appears to embody a degree of invariance to melodic inversion. Features that outline the same interval patterns, such as $(0, -5, -10, -5)$ and $(0, 5, 10, 5)$, are typically mapped to similar coordinates, regardless of their melodic contour. There may be some invariance to mode, too, with the major scale fragment $(0, -2, -3, -5)$ loading onto Component 1 with a similar magnitude as the minor scale equivalent $(0, -2, -4, -5)$ --- repeated, also, for Component 4 and the major $(0, 4, 7, 11)$ and minor $(0, 3, 7, 10)$ arpeggios.
