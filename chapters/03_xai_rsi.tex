...
\begin{sidewaystable}[]
    \caption[Experiment results for models trained with multiple input representations.]{Experiment results for models trained with multiple input representations. Note that, when the number of attention heads is 0, self-attention is not used.}
...
\begin{figure}[h!]
  ...
  \caption[Concept activation vector examples.]{Concept activation vector examples. The musical notation shows an example exercise taken from the ``Modal Fourthy Voicings'' chapter in \citet[p. 52]{Haerle1994}.}
...
\begin{figure}[h!]
  ...
  \caption[McCoy Tyner,``Tivoli'' (1991) transcription.]{McCoy Tyner,``Tivoli'' (1991) transcription. The musical notation shows a transcription of the final 30 seconds from an unaccompanied performance by McCoy Tyner (taken from the album ``Soliloquy'', original composition by Dexter Gordon). Transcription created by the author.}
